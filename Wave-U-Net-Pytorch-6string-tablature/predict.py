...
def main(args):
    ...
    # if args.patience<0:
    state = model_utils.load_model(model, None, args.load_model, args.cuda) # NOTE: if! patience<0
    ...
    data.utils.write_wav(os.path.join(output_folder, os.path.basename(args.input) + "_pred.wav"), mix_pred, args.sr)
