...
class ConvLayer(nn.Module):
    def __init__(self, n_inputs, n_outputs, kernel_size, stride, conv_type, transpose=False, padding=0):
        ...
        if self.transpose:
            ...
            self.filter = nn.Conv1d(n_inputs, n_outputs, self.kernel_size, stride, padding=padding) # __gbastas__
