...
def compute_loss(model, inputs, targets, criterion, compute_grad=False):
    ...
    if model.separate:
        ...
        for inst in model.instruments:
            ...
            # print('inputs', inputs.shape) # (4, 1, 96961)
            # print('output[inst]', output[inst].shape) # (4, 1, 88409)
            # print('targets[inst]', targets[inst].shape) # (4, 1, 88409)
