...
class DataGenerator(Sequence):
    def __init__(self, list_IDs, data_path="../data/spec_repr_target/", batch_size=128, shuffle=True, label_dim = (6,21), spec_repr="c", con_win_size=9, n_stfts=1):
        ...
        if self.spec_repr == "c":
            ...
            # self.X_dim = (self.batch_size, 192, self.con_win_size, 7)
            self.X_dim = (self.batch_size, 192, self.con_win_size, self.n_stfts)
            # self.X_dim = (self.batch_size, 192, self.con_win_size, 6)
            # self.X_dim = (self.batch_size, 1344, self.con_win_size, 1)
